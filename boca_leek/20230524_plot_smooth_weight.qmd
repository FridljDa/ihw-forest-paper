...
# Create a sample data frame
df <- data.frame(x = 1:5, y = 1:5, category = letters[1:5])

# Create the ggplot with a specific RColorBrewer palette
plot <- ggplot(df, aes(x, y, fill = category)) +
  geom_bar(stat = "identity") +
  scale_color_viridis_c()
  #scale_fill_brewer(palette = "YIOrRd")  # Use the "Set3" palette
#Y1OrRd
# Display the plot
print(plot)
...
plot_weights_quantile_2d(ihw_quantiles) +
  ...
  ylab("N rank") +
  scale_color_viridis_c()#+
  #scale_color_gradient(trans = "log", direction = -1) #pseudo_
```
