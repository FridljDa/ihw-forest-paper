...
#library("IHW")
devtools::load_all("/Users/default/GoogleDrive/currentDocumants/Studium/Master/3.Semester/Masterarbeit/R/IHW_bioconductor/")
```
...
sim <-foreach(i=1:nrow(group_sim_combs)) %dorng% {
                                  print(i);
...
```{r}
ihw_grouped_sim_forest <- foreach(sim_i =sim) %dopar% {
  Ps_i <- sim_i$Ps
  Xs_i <- sim_i$Xs_i
