...
```{r,  message=F}
ihw_bocaleek <- ihw(pvalue, covariate_noise, folds = folds, alpha = 0.1, strat = "BocaLeek", ntrees = ntrees, taus = taus, nbins = nbins, lambda = lambda)
