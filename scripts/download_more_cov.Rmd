...
track_table <- tribble(
  ~name, ~track, ~table,
  # Layered H3K27Ac
  "H3K27Ac_1","wgEncodeRegMarkH3k27ac", "wgEncodeBroadHistoneGm12878H3k27acStdSig",
...
#snp_chr1_cov_list <- lapply(seq_len(2), function(i){
  ...
  print("downloaded")
  print("joining")
  snp_chr1_covi <- tidygenomics::genome_join_closest(snp_chr1 %>% mutate(chr = chrsnp, start = pos, end = pos),
  ...
  print("saving")
  saveRDS(snp_chr1_covi, file.path(root_dir, paste0("data/downloaded_covariates/more_cov_sep/snp_chr1_cov",i,".Rds")))
  print("saved")
...
#snp_chr2_cov_list <- lapply(seq_len(2), function(i){
  ...
  print("downloaded")
  print("joining")
  snp_chr2_covi <- tidygenomics::genome_join_closest(snp_chr2 %>% mutate(chr = chrsnp, start = pos, end = pos),
  ...
  print("saving")
  saveRDS(snp_chr2_covi, file.path(root_dir, paste0("data/downloaded_covariates//more_cov_sep/snp_chr2_cov",i,".Rds")))
  print("saved")
