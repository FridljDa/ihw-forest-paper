...
library(here)
library(purrr)
#devtools::install(here("IHWForestPaper"))
...
high_dim_res_sim <- latest_files(here("simulation/data"), "_eval_high_dim_sim.Rds")

# For "_eval_high_dim_sim_adapt.Rds"
high_dim_res_adapt <- latest_files(here("simulation/data"), "_eval_high_dim_sim_adapt.Rds")
