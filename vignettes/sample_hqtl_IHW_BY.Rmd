...
```{r, eval = T, include=T}
snp_chr1 <- snp_chr1 %>% slice(1:20)
snp_chr2 <- snp_chr2 %>% slice(1:20)

peaks_chr1 <- peaks_chr1 %>% slice(1:20)
peaks_chr2 <- peaks_chr2 %>% slice(1:20)
```
...
#Sys.setenv(BIOMART_CACHE='/tmpdata/fridljan/biomaRt')
```
